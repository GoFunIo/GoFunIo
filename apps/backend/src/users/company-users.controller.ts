...
export class CompanyUsersController {
  ...
  @Get()
  list(@CurrentUser() user: User): Promise<User[]> {
    return this.companyUsers.list(user.companyId);
  }
  ...
  update(
    ...
    return this.companyUsers.update(user, id, body);
  }
  ...
  remove(
    ...
    return this.companyUsers.remove(user, id);
  }
}
